...
const Contact = () => {
  return (
    <Grid container spacing={0} sx={{
      ...
      <Box mb={2}>
        <Typography color="white" variant="h5">E-mail</Typography>
        <EmailIcon sx={{ color: 'white' }} /> <Typography color="white" variant="h6" component="a" href="mailto:daniel.swinney@gmail.com">daniel.swinney@gmail.com</Typography>
